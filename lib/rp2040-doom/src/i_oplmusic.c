...
{
    {
        ...
        debug_show_hex(0xB0000001); // B.1: enter I_OPL_InitMusic
    }
#if !DOOM_TINY
    ...
    {
        extern void debug_show_hex(uint32_t);
        debug_show_hex(0xB0000002); // B.2: after OPL_Init, before OPL_InitRegisters
    }
    ...
    {
        extern void debug_show_hex(uint32_t);
        debug_show_hex(0xB0000003); // B.3: after OPL_InitRegisters
    }
    ...
    {
        extern void debug_show_hex(uint32_t);
        debug_show_hex(0xB0000004); // B.4: after LoadInstrumentTable
    }
